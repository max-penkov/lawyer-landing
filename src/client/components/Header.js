...
class Header extends Component {
	...
	render() {
		...
		return (
			...
			<header onScroll={this.listenScrollEvent} className={classNames({
				'scrollActive': this.state.vPos > 0,
				...
				<div className="wrap container">
					...
					<div className="logo_wrap">
						<Link to="/">
							...
							<img src={`${webConfig.siteURL}/assets/graphics/logo_white.png`} alt="Logo"
								 className="white"/>
						</Link>
					</div>

					<div className="mobile">
                        <span className={classNames({'icon': true, 'mobileNavActive': this.state.mobileToggle})}
